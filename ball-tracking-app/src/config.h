...
public:
    ...
    { return std::format("{:12}", value().get()); }
    ...
    static auto defaults() noexcept -> config {
        return {
            .xml{
                ...
                .tagname{"settings"}},
            .pid{
                .proportional{"proportional", dtype::fraction, 1.1},
                .integral{"integral", dtype::fraction, 2.2},
                .derivative{"derivative", dtype::fraction, 3.3}},
            .vision{
                .circlesize{"circle size", dtype::fraction, 4.4}},
            .cam{
                .frame{
                ...
                .format{"color format", dtype::uint8, ::cam::format::RGB},
                .exposure{"exposure", dtype::uint8, 30},
                .sharpness{"sharpness", dtype::uint8, 0},
                .contrast{"contrast", dtype::uint8, 150},
                .brightness{"brightness", dtype::uint8, 150},
                .hue{"hue", dtype::uint8, 143},
